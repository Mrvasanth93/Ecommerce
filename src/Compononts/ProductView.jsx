...
import { productBase, orderbase, imageBase } from "../utils";
...
const ProductView = () => {
    ...
    return (
        <>
            {
                !product ? <Loader /> : <div className="productview">
                    <div className="productview-container">
                        ...
                        <div className="product-content">
                            <div className="product-content-img">
                                {product && product[0].image && <img src={`${imageBase}${product[0].image}`} alt="" />}
                            </div>
                                ...
                                <div className="review">
                                    ...
                                    <div className="review-container">
                                        <div className="profile-logo">
                                            ...
                                            <div className="reviewer-name">Vasanth</div>
                                        </div>
                                        <h3>⭐⭐⭐⭐⭐</h3>
